  ...
  "extendedIngredients": [
      {
          ...
          "meta": [
              "pure",
              "(or other chile powder, not a blend)"
          ],
          "metaInformation": [
              "pure",
              "(or other chile powder, not a blend)"
  ...
  "analyzedInstructions": [
      {
          ...
          "steps": [
              ...
              {
                  "number": 3,
                  "step": "Add the vegetable broth, bring to a boil, reduce heat, and cover. Simmer until all the water is absorbed, about 20 minutes.",
                  "ingredients": [
                      {
                          "id": 6615,
                          "name": "vegetable broth",
              ...
              {
                  "number": 4,
                  "step": "Remove from heat and allow to cool. While the quinoa is cooking, make the dressing in a small bowl or measuring cup: whisk together the lemon juice, 3 tablespoons broth, chia/flax seeds, chile powders, cumin, and salt. Allow to stand until the chia seeds start to thicken the dressing.",
                  "ingredients": [
                      {
                          "id": 9152,
                          "name": "lemon juice",
              ...
              {
                  "number": 6,
                  "step": "Add half of the dressing and massage it into the kale using a wringing motion until the kale is very tender. Two minutes of massaging should do it, but the longer, the better.",
                  "ingredients": [
                      {
                          "id": 11233,
                          "name": "kale",
              ...
              {
                  "number": 8,
                  "step": "Mix well and refrigerate until ready to serve. Just before serving, check the seasoning and add more lemon juice, chile powder, cumin, and salt, as needed. Stir in chopped avocado, if desired, or serve with slices of avocado on the side.",
                  "ingredients": [
                      {
                          "id": 2009,
                          "name": "chili powder",
